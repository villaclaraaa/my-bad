...
public interface IMatchupService
{
    ...
    Task<List<HeroMatchupModel>> CalcutaleBestMatchupVersusEnemies(List<int> ids, List<int>? heroesInPool);
    ...
    Task<List<HeroMatchupModel>> CalcutaleBestMatchupWithAllies(List<int> ids, List<int>? heroesInPool);
    ...
    Task<List<HeroMatchupModel>> CalcutaleBestMatchupCombined(List<int> enemyIds, List<int> allyIds, List<int>? heroesInPool);
}

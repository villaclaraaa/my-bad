...
public interface IMatchupService
{
    ...
    Task UpdateMatchups(Dictionary<(int HeroId, int OtherHeroId), GamesResultsStat> heroStats, bool isEnemyMatchup, int patchId);
    ...
    Task<List<HeroMatchupModel>> CalcutaleBestMatchupVersusEnemies(List<int> ids, List<int>? heroesInPool, int? patchId);
    ...
    Task<List<HeroMatchupModel>> CalcutaleBestMatchupWithAllies(List<int> ids, List<int>? heroesInPool, int? patchId);
    ...
    Task<List<HeroMatchupModel>> CalcutaleBestMatchupCombined(List<int> enemyIds, List<int> allyIds, List<int>? heroesInPool, int? patchId);
}
